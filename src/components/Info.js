    ...
    render() {
        ...
        return (
            <Container className="landing disp-flex" style={{ flexDirection: "column", marginTop: "50px", width: "50%" }}>
                ...
                <p>Skyah is powered by the <a className="custom-a" href="https://3.143.149.23/">Hysky API</a>, It was mainly created to help developers work with the huge amounts of auctions that are fetched through the Skyblock Auction House API, This is an Open source project so if you are a PHP developer you could contribute <a className="custom-a" target="_blank" href="https://hyskyapi.com/">here</a>.</p>
