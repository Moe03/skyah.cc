    ...
    render() {
        ...
        return (
            <Container className="landing disp-flex" style={{ flexDirection: "column", marginTop: "50px", width: "50%" }}>
                ...
                <p>Skyah is powered by the <a className="custom-a" href="http://hyskyapi.cc">Hysky API</a> Project, It was created to help developers work with the huge amounts of auctions that are fetched through the Skyblock Auction House API, Make sure to check it out <a className="custom-a" target="_blank" href="https://hyskyapi.cc">here</a>.</p>
